...
function HomeScreen() {
    useEffect(() => {
        ...
        const handleVoice = () => {
            const ttsText = 'Hello, it is time to take your medicine. Please take paracetamol after meals. Thank you.';
            Tts.speak(ttsText);
        };

        handleVoice();
        const intervalId = setInterval(handleVoice, 21600000); // 6 hours
